...
public class KhuyenMaiPanel extends JPanel {
    ...
    private JPanel createSearchPanel() {
        ...
        // Nút tìm kiếm
        searchButton = createStyledButton("Tìm Kiếm", createSearchIcon(16, 16), new Color(41, 128, 185));
    ...
    private JButton createStyledButton(String text, Icon icon, Color color) {
        ...
        button.setOpaque(true);  // Đảm bảo màu nền sẽ được hiển thị
        ...
        button.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent evt) {
                button.setBackground(color.brighter());  // Tạo hiệu ứng sáng khi hover
            }

            @Override
            public void mouseExited(MouseEvent evt) {
                button.setBackground(color);  // Quay lại màu gốc khi không hover
            }

            @Override
            public void mousePressed(MouseEvent evt) {
                button.setBackground(color.darker());  // Tạo hiệu ứng tối khi nhấn nút
            }

            @Override
            public void mouseReleased(MouseEvent evt) {
                button.setBackground(color);  // Quay lại màu gốc sau khi thả nút
            }
        });
    ...
    private Icon createSearchIcon(int width, int height) {
        return new ImageIcon(createIconImage(width, height, new Color(255, 0, 0), g -> {
    ...
    private Icon createRefreshIcon(int width, int height) {
        return new ImageIcon(createIconImage(width, height, new Color(67, 255, 0), g -> {
            g.setStroke(new BasicStroke(1.5f));
            int centerX = width / 2;
